...
var CEnum = 'int32';
var TOX_ERR_CONFERENCE_NEW = CEnum;
...
ToxOld.prototype.createLibrary = function(libpath) {
  ...
  return ffi.Library(libpath, {
    'tox_conference_new':         [ 'uint32',  [ ToxPtr, ref.refType(TOX_ERR_CONFERENCE_NEW) ] ],
    'tox_callback_conference_invite':  [ 'void', [ ToxPtr, GroupInviteCallback, UserData ] ],
    'tox_callback_conference_message': [ 'void', [ ToxPtr, GroupMessageCallback, UserData ] ],
    'tox_callback_conference_namelist_change': [ 'void', [ ToxPtr, GroupNamelistChangeCallback, UserData ] ],
    'tox_callback_conference_title': [ 'void', [ ToxPtr, GroupTitleCallback, UserData ] ],
    'tox_conference_get_chatlist_size':     [ 'uint32', [ ToxPtr ] ],
    'tox_conference_get_chatlist':       [ 'uint32', [ ToxPtr, Int32Ptr, 'uint32' ] ],
    'tox_conference_delete':      [ 'int',    [ ToxPtr, 'int' ] ],
    'tox_conference_get_title':    [ 'int',    [ ToxPtr, 'int', UInt8Ptr, 'uint32' ] ],
    'tox_conference_send_message': [ 'int',    [ ToxPtr, 'int', UInt8Ptr, 'uint16' ] ],
    'tox_conference_peer_count': [ 'int',    [ ToxPtr, 'int' ] ],
    'tox_conference_peer_get_name':     [ 'int',    [ ToxPtr, 'int', 'int', UInt8Ptr ] ],
    'tox_conference_peer_number_is_ours': [ 'uint', [ ToxPtr, 'int', 'int' ] ],
    'tox_conference_peer_get_public_key':  [ 'int',    [ ToxPtr, 'int', 'int', UInt8Ptr] ],
    'tox_conference_set_title':    [ 'int',    [ ToxPtr, 'int', UInt8Ptr, 'uint8' ] ],
    'tox_conference_invite':      [ 'int',    [ ToxPtr, 'int32', 'int' ] ],
    'tox_conference_join':     [ 'int',    [ ToxPtr, 'int32', UInt8Ptr, 'uint16' ] ]
    /*
...
/**
 * Asynchronous tox_conference_new(3).
 */
ToxOld.prototype.addGroupchat = function(callback) {
  ...
  this.getLibrary().tox_conference_new.async(this.getHandle(), function(err, res) {
    if(!err && res < 0) {
      err = createNegativeReturnError('tox_conference_new', res);
    }
...
/**
 * Synchronous tox_conference_new(3).
 * @return {Number} Groupchat number
 * @throws Error if tox_conference_new returns a negative value
 */
ToxOld.prototype.addGroupchatSync = function() {
  this._checkHandleSync();

  var groupnum = this.getLibrary().tox_conference_new(this.getHandle());
  if(groupnum < 0) {
    throw createNegativeReturnError('tox_conference_new', groupnum);
  }
...
ToxOld.prototype._initGroupInviteCb = function() {
  var _this = this;
  this._initCallback({
    api: this.getLibrary().tox_callback_conference_invite.bind(undefined, this.getHandle()),
...
ToxOld.prototype._initGroupMessageCb = function() {
  var _this = this;
  this._initCallback({
    api: this.getLibrary().tox_callback_conference_message.bind(undefined, this.getHandle()),
...
ToxOld.prototype._initGroupNamelistChangeCb = function() {
  var _this = this;
  this._initCallback({
    api: this.getLibrary().tox_callback_conference_namelist_change.bind(undefined, this.getHandle()),
...
ToxOld.prototype._initGroupTitleCb = function() {
  var _this = this;
  this._initCallback({
    api: this.getLibrary().tox_callback_conference_title.bind(undefined, this.getHandle()),
