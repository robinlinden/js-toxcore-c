...
ToxEncryptSave.prototype._createLibrary = function(libpath) {
  ...
  return ffi.Library(libpath, {
    'tox_pass_key_derive':           [ 'bool', [ ref.refType(ToxPassKey), UInt8Ptr, 'size_t', ref.refType(TOX_ERR_KEY_DERIVATION) ] ],
    'tox_pass_key_derive_with_salt': [ 'bool', [ ref.refType(ToxPassKey), UInt8Ptr, 'size_t', UInt8Ptr, ref.refType(TOX_ERR_KEY_DERIVATION) ] ],
    ...
    'tox_pass_key_decrypt':          [ 'bool', [ ref.refType(ToxPassKey), UInt8Ptr, 'size_t', UInt8Ptr, ref.refType(TOX_ERR_DECRYPTION) ] ],
    'tox_pass_key_encrypt':          [ 'bool', [ ref.refType(ToxPassKey), UInt8Ptr, 'size_t', UInt8Ptr, ref.refType(TOX_ERR_ENCRYPTION) ] ]
  });
};
...
ToxEncryptSave.prototype._performDerive = function(opts) {
  ...
  if(useSalt) {
    api = api.bind(undefined, out, pass, pass.length, salt, eptr);
  } else {
    api = api.bind(undefined, out, pass, pass.length, eptr);
  }
