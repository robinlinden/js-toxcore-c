...
ToxEncryptSave.prototype._createLibrary = function(libpath) {
  ...
  return ffi.Library(libpath, {
    'tox_pass_key_derive':           [ ref.refType(ToxPassKey), [ UInt8Ptr, 'size_t', ref.refType(TOX_ERR_KEY_DERIVATION) ] ],
    'tox_pass_key_derive_with_salt': [ ref.refType(ToxPassKey), [ UInt8Ptr, 'size_t', UInt8Ptr, ref.refType(TOX_ERR_KEY_DERIVATION) ] ],
